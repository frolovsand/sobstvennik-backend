...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    interestFormat: Schema.Attribute.Enumeration<['rent', 'sale', 'viewing']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::lead.lead'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    propertyTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    sourcePage: Schema.Attribute.String;
    statusord: Schema.Attribute.Enumeration<['new', 'in_progress', 'closed']> &
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.Component<'property.section-type1', true>;
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    interestFormat: Schema.Attribute.Enumeration<
      ['rent', 'buy', 'rent_and_buy']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
